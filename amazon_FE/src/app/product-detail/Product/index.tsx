...
export default function Product(props: any) {
    ...
    useEffect(() => {
        //call API
        axios.get(`http://localhost:8080/get-product-by-id/${id}`).then(value => {
            // console.log(value);
    ...
    return (
        <Row gutter={16} className='my-16'>
            <Col span={10}>
                <Image className='w-full h-[400px]' src={product != null ? product.image : ""}></Image>
            </Col>
            <Col span={14}>
                ...
                <p className='font-[500] text-xl my-5'>$ {product != null ? product.price : ""}</p>
                <div>
