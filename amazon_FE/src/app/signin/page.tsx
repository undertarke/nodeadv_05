...
export default function AuthenSignIn() {
  ...
  return (
    ...
    <button onClick={()=>{setFound(!found)}}>{found?<CaretDownOutlined />:<CaretRightOutlined />}Need help?
</button>
    {found && (
      <ul>
        <li><Link href={"/"}>Forgot your password?</Link></li>
        <li><Link href={"/"}>Other issues with Sign-In
</Link></li>
      </ul>
    )}
